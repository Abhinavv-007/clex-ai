...
(function () {
    ...
    window.addEventListener('scroll', () => {
        if (window.scrollY > 50) {
            ...
            header.classList.add('bg-[#02050f]/80', 'backdrop-blur-md', 'border-b', 'border-white/10', 'py-4');
        } else {
            header.classList.add('py-8');
            header.classList.remove('bg-[#02050f]/80', 'backdrop-blur-md', 'border-b', 'border-white/10', 'py-4');
        }
    });
})();
        ...
        for (let i = 0; i < cols; i++) {
            for (let j = 0; j < rows; j++) {
                ...
                if (intensity > 0.05) {
                    ...
                    if (intensity > 0.8 || colorNoise > 0.7) { r = 230; g = 255; b = 100; }
                    else if (intensity > 0.5 || colorNoise > 0.3) { r = 80; g = 240; b = 150; }
                    else if (intensity > 0.2) { r = 40; g = 180; b = 255; }
                    else { r = 20; g = 80; b = 180; }
...
function getProviderLogo(provider) {
    ...
    switch (provider.toLowerCase()) {
        case 'openai':
            ...
            colorClass = "text-emerald-400"; textName = "OpenAI"; break;
        case 'meta':
            ...
            colorClass = "text-blue-400"; textName = "Meta"; break;
        case 'google':
            ...
            colorClass = "text-white"; textName = "Google"; break;
        case 'nvidia':
            ...
            colorClass = "text-green-400"; textName = "NVIDIA"; break;
        case 'deepseek ai':
        case 'deepseek-ai':
            ...
            colorClass = "text-indigo-400"; textName = "DeepSeek"; break;
        case 'mistral ai':
        case 'mistralai':
            ...
            colorClass = "text-orange-400"; textName = "Mistral AI"; break;
        case 'qwen':
            ...
            colorClass = "text-purple-400"; textName = "Qwen"; break;
        case 'microsoft':
            ...
            colorClass = "text-blue-400"; textName = "Microsoft"; break;
        case 'ibm':
            ...
            colorClass = "text-blue-400"; textName = "IBM"; break;
        case 'bytedance':
            ...
            colorClass = "text-red-400"; textName = "ByteDance"; break;
        case 'ai21 labs':
        case 'ai21':
            ...
            colorClass = "text-amber-400"; textName = "AI21 Labs"; break;
        case 'tiiuae':
            ...
            colorClass = "text-sky-400"; textName = "TII UAE"; break;
        case 'baai':
            ...
            colorClass = "text-teal-400"; textName = "BAAI"; break;
        default:
            ...
            textName = provider.split(/[-\s]/).map(w => w.charAt(0).toUpperCase() + w.slice(1)).join(' ');
    }
